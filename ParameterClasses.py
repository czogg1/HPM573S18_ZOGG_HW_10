...
class Therapies(Enum):
    """ anticoagulation versus no therapy """
    NONE = 0
    ANTICOAG = 1
...
class ParametersFixed():
    def __init__(self, therapy):
        ...
        if self._therapy == Therapies.NONE:
            self._annualTreamentCost = Data.None_COST
        else:
            self._annualTreamentCost = Data.Anticoag_COST
            ...
            for s in HealthStats:
                ...
                if s == HealthStats.POST_STROKE:
                    ...
                    prob_matrix[s.value][s.value] \
                        = 1 - prob_matrix[s.value][HealthStats.STROKE.value] - prob_matrix[s.value][
                        HealthStats.DEATH.value]
                else:
    ...
    def get_annual_treatment_cost(self):
        return self._annualTreamentCost
