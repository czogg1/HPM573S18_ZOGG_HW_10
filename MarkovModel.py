...
class PatientCostUtilityMonitor:
    ...
    def update(self, k, current_state, next_state):
        ...
        # update total discounted cost and utility (corrected fo the half-cycle effect)
    ...
    def get_total_discounted_utility(self):
        """ returns total discounted utillity """
...
class CohortOutputs:
    def __init__(self, simulated_cohort):
        ...
        self._count_strokes = []            # patients' stroke counts
        ...
        self._sumState_number_strokes = StatCls.SummaryStat('Stroke count', self._count_strokes)
